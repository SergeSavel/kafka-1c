...
Процедура ПриЧтенииНаСервере(ТекущийОбъект)
	...
	ПроксиПароль = ТекущийОбъект.ПроксиПароль.Получить();
	
	КафкаПароль = ТекущийОбъект.КафкаПароль.Получить();
...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	ТекущийОбъект.ПроксиПароль = Новый ХранилищеЗначения(ПроксиПароль);
	
	ТекущийОбъект.КафкаПароль = Новый ХранилищеЗначения(КафкаПароль);
