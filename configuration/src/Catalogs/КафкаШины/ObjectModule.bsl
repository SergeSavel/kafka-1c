...
Процедура ПередЗаписью(Отказ)
	...
	Если Не ЭтоГруппа Тогда
		...
		Если ОбменНаправление = Перечисления.КафкаНаправленияОбмена.Загрузка Тогда
			Если ПриемПроцедура = ""
			Или СтрНайти(ПриемПроцедура, " ") > 0
			Или СтрНайти(ПриемПроцедура, "(") > 0
			Или СтрНайти(ПриемПроцедура, ")") > 0
			Или СтрНайти(ПриемПроцедура, ";") > 0
			Или СтрНайти(ПриемПроцедура, "=") > 0
...
Процедура ПриЗаписи(Отказ)
	...
	Если Не ЭтоГруппа Тогда
		...
		КафкаВызовСервера.ОбновитьРегламентныеЗадания(Ссылка, ПометкаУдаления);
...
Процедура ПередУдалением(Отказ)
	...
	Если Не ЭтоГруппа Тогда
		...
		КафкаВызовСервера.ОбновитьРегламентныеЗадания(Ссылка, Истина);
