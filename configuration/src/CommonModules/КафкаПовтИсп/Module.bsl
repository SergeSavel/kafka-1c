...
Функция ОписаниеОбъектаМетаданных(ПолноеИмя) Экспорт
	...
	Результат.Вставить("ПолноеИмя",		ОбъектМетаданных.ПолноеИмя());
	...
	Результат.Вставить("ЭтоПеречисление"			, (Результат.Вид = "Перечисление"));
	Результат.Вставить("ЭтоПланВидовХарактеристик"	, (Результат.Вид = "ПланВидовХарактеристик"));
	Результат.Вставить("ЭтоПланСчетов"				, (Результат.Вид = "ПланСчетов"));
	...
	Результат.Вставить("ЭтоЗадача"					, (Результат.Вид = "Задача"));
	...
	Результат.Вставить("ЭтоНезависимыйРегистр", Результат.ЭтоРегистрСведений И ОбъектМетаданных.РежимЗаписи = Метаданные.СвойстваОбъектов.РежимЗаписиРегистра.Независимый);
	...
	Результат.Вставить("ЭтоРегистрНакопленияОбороты", Результат.ЭтоРегистрНакопления И ОбъектМетаданных.ВидРегистра = Метаданные.СвойстваОбъектов.ВидРегистраНакопления.Обороты);
	Результат.Вставить("ЭтоРегистрНакопленияОстатки", Результат.ЭтоРегистрНакопления И ОбъектМетаданных.ВидРегистра = Метаданные.СвойстваОбъектов.ВидРегистраНакопления.Остатки);
	...
	ИначеЕсли Результат.ЭтоРегистрСведений Тогда
		Если ОбъектМетаданных.ПериодичностьРегистраСведений <> Метаданные.СвойстваОбъектов.ПериодичностьРегистраСведений.Непериодический И ОбъектМетаданных.ОсновнойОтборПоПериоду Тогда
...
Функция МенеджерОбъектаМетаданных(ПолноеИмя) Экспорт

	Попытка
		Поз = СтрНайти(ПолноеИмя, ".");
		ТаблицаВид = Лев(ПолноеИмя, Поз-1);
		ТаблицаИмя = Сред(ПолноеИмя, Поз+1);
...
Функция СтрокаСоединенияИнфобазы() Экспорт
	...
	Возврат КафкаСервер.СтрокаСоединенияИнфобазы();
