...
Минимально необходимая версия шлюза указана в описании устанавливаемого релиза [подсистемы](install.md); более новый шлюз подходит.
...
Шлюз обновляется независимо от подсистемы: достаточно, чтобы его версия была не ниже минимально необходимой, указанной в описании релиза подсистемы. При несовместимой версии шлюза обмен завершается ошибкой «Неизвестная версия бинарной сериализации». После обновления проверяйте версию шлюза в шапке рабочего места администратора.
